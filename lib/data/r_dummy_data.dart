...
static final List<ProductModel> products = [
  ...
  ProductModel(
    ...
    brand: BrandModel(id: '7', image: '', name: 'Samsung'),
    images: [
      '',
      '',
      '',
  ...
  ProductModel(
    ...
    brand: BrandModel(id: '7', image: '', name: 'Tomi'),
    salePrice: 10,
    sku: 'ABR4568',
    categoryId: '4',
    attributes: [
  ...
  ProductModel(
    ...
    brand: BrandModel(id: '1', image: '', name: 'Nike'),
    images: [
      '',
      '',
      '',
  ...
  ProductModel(
    ...
    brand: BrandModel(id: '2', image: '', name: 'Adidas'),
    images: [
      '',
      '',
      '',
  ...
  ProductModel(
    ...
    description:
        'Flutter is Google’s mobile UI open source framework to build high-quality native (super fast) interfaces for iOS and Android apps with the unified codebase.',
    brand: BrandModel(id: '8', image: '', name: 'Kenwood'),
    images: [
      '',
      '',
      '',
  ...
  ProductModel(
    ...
    brand: BrandModel(id: '9', image: '', name: 'IKEA'),
    // salePrice: 400,1
    sku: 'ABR4568',
    categoryId: '13',
    attributes: [
  ...
  ProductModel(
    ...
    brand: BrandModel(id: '10', image: '', name: 'Acer'),
    images: [
      '',
      '',
      '',
  ...
  ProductModel(
    ...
    brand: BrandModel(id: '5', image: '', name: 'Apple'),
    // salePrice: 400,1
    sku: 'ABR4568',
    categoryId: '15',
    attributes: [
  ...
  ProductModel(
    ...
    brand: BrandModel(id: '5', image: '', name: 'iphone 8'),
    images: [
      '',
      '',
      '',
  ...
  static final List<BrandModel> brands = [
    BrandModel(id: '1', image: '', name: 'Nike', productsCount: 265, isFeatured: true),
    BrandModel(id: '2', image: '', name: 'Adidas', productsCount: 95, isFeatured: true),
    BrandModel(id: '8', image: '', name: 'Kenwood', productsCount: 36, isFeatured: false),
    BrandModel(id: '9', image: '', name: 'IKEA', productsCount: 36, isFeatured: false),
    BrandModel(id: '5', image: '', name: 'Apple', productsCount: 16, isFeatured: true),
    BrandModel(id: '10', image: '', name: 'Acer', productsCount: 36, isFeatured: false),
    BrandModel(id: '3', image: '', name: 'Jordan', productsCount: 36, isFeatured: true),
    BrandModel(id: '4', image: '', name: 'Puma', productsCount: 65, isFeatured: true),
    BrandModel(id: '6', image: '', name: 'ZARA', productsCount: 36, isFeatured: true),
    BrandModel(id: '7', image: '', name: 'Samsung', productsCount: 36, isFeatured: false),
  ];
